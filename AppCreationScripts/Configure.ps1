...
#> 
   ...
   Write-Host "Creating the AAD application (OAuth2-UserIdentity)"
   ...
   Write-Host "Done creating the service application (OAuth2-UserIdentity)"
   ...
   Add-Content -Value "<tr><td>service</td><td>$currentAppId</td><td><a href='$servicePortalUrl'>OAuth2-UserIdentity</a></td></tr>" -Path createdApps.html
